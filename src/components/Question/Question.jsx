...
const Question = () => {
    return (
        <div className='container px-10 py-10'>
            <div>
                <p className='text-2xl'>Q.1. What is the different of props and state?</p>
               
                <p><span className='text-2xl'>props:</span><br />
                ...
                (4).States can be used for rendering dynamic changes with the component. <br />
                (5).	State cannot be accessed by child components.
                 </p>
            </div>
            <div className='mt-8'>
                <p className='text-2xl'>Q.2.How dose useState Works ?</p>
                <p><span className='text-2xl'>useState:</span></p>
            ...
            <div className='mt-8'>
            <p className='text-2xl'>Q.3.How dose useEffect Works ?</p>
                <p><span className='text-2xl'>useEffect:</span></p>
            ...
            <div className='mt-8'>
            <p className='text-2xl'>Q.4.How dose React Works ?</p>
                <p><span className='text-2xl'>React:</span></p>
                <p>ReactJS is one of the most popular JavaScript libraries for mobile and web application development. Created by Facebook, React contains a collection of reusable JavaScript code snippets used for user interface (UI) building called components. React components work similarly to JavaScript functions as they accept arbitrary inputs called properties or props. It's possible to have as many components as necessary without cluttering your code</p>
            </div>
